					...
					<div class="panel-body">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label>Nama </label>
								<input type="text" name="nama" class="form-control" placeholder="Isikan Nama Anda">
							</div>
							<div class="form-group">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								<label>Email </label>
								<input type="email" name="email" class="form-control" placeholder="Rekomendasi@mail.com">
							</div>
							<div class="form-group">
								<label>Level </label>
