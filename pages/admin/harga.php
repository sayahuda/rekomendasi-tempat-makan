<?php
	...
	if(isset($_POST['simpan'])){
		...
		$sedikit = mysql_query("UPDATE V_HARGA SET BATAS_BAWAH='".$murah_bawah."', BATAS_ATAS='".$murah_atas."' WHERE status='Murah';");
		$banyak = mysql_query("UPDATE V_HARGA SET BATAS_BAWAH='".$sedang_bawah."', BATAS_ATAS='".$sedang_atas."', BATAS_TENGAH='".$sedang_tengah."' WHERE status='Menengah';");
		$banyak = mysql_query("UPDATE V_HARGA SET BATAS_BAWAH='".$mahal_bawah."', BATAS_ATAS='".$mahal_atas."' WHERE status='Mahal';");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="harga.php">Variabel Harga</a></li>
